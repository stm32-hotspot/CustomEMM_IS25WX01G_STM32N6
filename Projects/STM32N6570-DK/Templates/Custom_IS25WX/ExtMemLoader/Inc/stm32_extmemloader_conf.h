...
#define	STM32EXTLOADER_DEVICE_NAME            "IS25WX01G_STM32N6570-DK"
#define STM32EXTLOADER_DEVICE_TYPE            NOR_FLASH
#define	STM32EXTLOADER_DEVICE_ADDR            0x70000000
#define	STM32EXTLOADER_DEVICE_SIZE            (128U * 1024U * 1024U)
#define	STM32EXTLOADER_DEVICE_SECTOR_NUMBERS  32768
#define	STM32EXTLOADER_DEVICE_SECTOR_SIZE     (4U * 1024U) /* 4 KBytes */
